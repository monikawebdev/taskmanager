...
import { Home, CheckSquare, Briefcase, Calendar, BarChart2, Settings, LogOut, User, ChevronLeft } from "lucide-react";
        ...
        <div className="min-h-screen flex bg-gray-50">
            ...
            <div className="flex-1 p-8">
                ...
                <main className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* Today's Tasks */}
                    <div className="bg-green-50 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6">
                    ...
                    {/* Overdue Tasks */}
                    <div className="bg-red-50 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6">
                    ...
                    {/* Upcoming Tasks */}
                    <div className="bg-blue-50 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6">
                    ...
                    {/* Task List */}
                    <div className="bg-yellow-50 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 col-span-full lg:col-span-2">
                    ...
                    {/* Completion Progress */}
                    <div className="bg-green-50 rounded-xl shadow-md hover:shadow-lg transition-shadow p-6 flex flex-col items-center">
